...
--check/fake if doesnt exist
local wrapimmedate = wrapimmedate or function(func)
	local thread = coroutine.create(func)
	coroutine.resume(thread)
end

local function GetAdminRoot()
	return workspace.Tabby.Admin_House
end

local function GetAdminPads()
	return workspace.Terrain["_Game"].Admin.Pads
end

local function GetAdminPadGrids()
	return GetAdminRoot().Grids
end

local function GetAdminHouse()
	return GetAdminRoot().House
end

local function GetAdminBuilding()
	return GetAdminRoot()["Build_Stuff"]
end

local function GetAdminObby()
	return GetAdminRoot()["Obby Box"]
end

local function GetAdminObby2()
	return GetAdminRoot()["Obby"]
end
...
local function wrapf3x(f3x)
	...
	-- basics
	api.delete = function(part: {Instance}) -- TODO: should change this
		serverendpoint:InvokeServer("Remove", part)
	end
	
	api.restore = function(parts: {Instance})
		serverendpoint:InvokeServer("UndoRemove", parts)
	end

	api.clone = function(items: {Instance}, parent: Instance)
		serverendpoint:InvokeServer("Clone", items, parent)
	end

	api.create = function(partType, position: CFrame, parent: Instance)
		serverendpoint:InvokeServer("CreatePart", partType, position, parent)
	end

	api.group = function(partType, parent: Instance, items: {Instance})
		serverendpoint:InvokeServer("CreateGroup", partType, parent, items)
	end

	api.ungroup = function(groups: {{Instance}})
		serverendpoint:InvokeServer("Ungroup", groups)
	end

	api.setParent = function(items: {Instance}, parent: any)
		serverendpoint:InvokeServer("SetParent", items, parent)
	end

	api.setName = function(items: {Instance}, name: string)
		serverendpoint:InvokeServer("SetName", items, name)
	end
	
	-- sync/changes
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L458
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L541
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L608
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L691
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L738
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L793
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L853
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L928
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L988
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1066
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1118
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1185
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1246
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1314
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1353
	-- https://github.com/F3XTeam/RBX-Building-Tools/blob/8af2073ede233c198d898cefabc4ae2466cc2190/SyncAPI.lua#L1392

	api.createWelds = function(parts: {Instance}, targetPart: Instance)
		serverendpoint:InvokeServer("CreateWelds", parts, targetPart)
	end

	api.removeWelds = function(welds: {Instance})
		serverendpoint:InvokeServer("RemoveWelds", welds)
	end

	api.undoRemovedWelds = function(welds: {Instance})
		serverendpoint:InvokeServer("UndoRemovedWelds", welds)
	end

	api.setLocked = function(items: {Instance}, locked: boolean)
		serverendpoint:InvokeServer("SetLocked", items, locked)
	end
	
	-- utils
	api.kill = function(plyr)		
		wrapimmedate(function() api.delete({plyr.Head}) end)
	end

	return api -- TODO: queue api queries for once they are possible
end
...
local function getf3x()
	...
	error("please run ':startergive me b' before using commands")
end

-- infinite yield dex (Modified for kahx)
local nodes = {}
local selection
		...
		local function main()
			...
			Explorer.InitRightClick = function()
				...
				context:Register("DELETE",{Name = "Delete", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Del", OnClick = function()
					...
					local sList = selection.List
					for i = 1,#sList do
						local api = getf3x() -- get kahx compatible API
						pcall(function()
							wrapimmedate(function()
								api.delete({sList[i].Obj})
							end)
						end)
					end
					selection:Clear()
